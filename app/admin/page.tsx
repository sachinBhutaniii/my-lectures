...
import VaishnavaCalendarAdmin from "@/components/VaishnavaCalendarAdmin";
...
type Tab = "videos" | "transcripts" | "users" | "jnana" | "sadhana" | "feedback" | "calendar" | "settings";
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] overflow-x-hidden w-full">
      ...
      <div className="mx-auto max-w-6xl px-3 py-4 sm:p-6 w-full min-w-0">
        ...
        {activeTab === "sadhana"     && <SadhanaAdmin />}
        {activeTab === "feedback"    && <FeedbackAdmin />}
        {activeTab === "calendar"    && <VaishnavaCalendarAdmin />}
        {activeTab === "settings"    && isParentAdmin && <AdminSettingsPanel />}
      </div>
