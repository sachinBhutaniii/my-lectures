    ...
    <div className="h-screen bg-black text-white w-full max-w-4xl xl:max-w-6xl mx-auto flex flex-col overflow-hidden">
      ...
      {activeTab === "transcript" && (
        <div className={`flex items-stretch gap-2 px-4 flex-shrink-0 transition-all duration-300 ${readingMode ? "max-h-0 opacity-0 pb-0 overflow-hidden" : "max-h-20 opacity-100 pb-3 overflow-visible"}`}>
          ...
          <div className="flex-1 flex items-center gap-2 border border-gray-700 rounded-lg px-3 py-0 bg-gray-900/50 min-w-0">
          ...
          <button
            ...
            className={`flex-shrink-0 flex items-center gap-1.5 border rounded-lg px-3 transition-colors ${
              autoScroll
