...
export default function AddToPlaylistModal({
  ...
  return (
    <>
      ...
      {/* Bottom sheet */}
      <div
        className={`fixed bottom-0 left-0 right-0 z-50 bg-transparent transition-transform duration-300 ease-out ${
      ...
      >
        <div className="mx-auto w-full max-w-4xl xl:max-w-6xl">
          ...
          {/* Card */}
          <div className="mx-4 mb-4 bg-[#111] rounded-2xl border border-gray-800 shadow-2xl overflow-hidden">
            {/* Header */}
            <div className="px-5 pt-3 pb-3 border-b border-gray-800">
              ...
              {!creating ? (
                ...
                <div className="flex items-center gap-2 py-2">
                  ...
                  <button
                    ...
                    className="text-gray-500 px-1 py-2"
                  >
                    ✕
                  </button>
                </div>
                  ...
                  >
                        ...
                        <div className="w-full h-full flex items-center justify-center">
                          ...
                          >
                            <path
                              strokeLinecap="round"
                              strokeLinejoin="round"
                              d="M3.75 6.75h16.5M3.75 12h10.5m-10.5 5.25h10.5"
                            />
                          </svg>
                        </div>
                      )}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-gray-500 text-xs">
                        {pl.lectures.length} lecture
                        {pl.lectures.length !== 1 ? "s" : ""}
                      </p>
                    </div>
